...
console.group('Country Names')
for (const country of countries) {
    console.log(country.name)
}
console.groupEnd('Country Names')

console.group('Country Name and Population')
for (const country of countries) {
    console.log(`${country.name} - ${country.population}`)
}
console.groupEnd('Country Name and Population')

console.group('Outer Group')
console.group('Inner Group One')
console.log('Hello World!')
console.groupEnd('Inner Group One')
console.group('Inner Group Two')
console.log('Hello People!')
console.groupEnd('Inner Group Two')
